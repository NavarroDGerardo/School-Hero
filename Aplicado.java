...
public class Aplicado extends Alumno implements Serializable{
	
	public Aplicado(String nombre, int x, int y, int promedio, int ataque, int defensa, int xP, int numeroDeMobsAsesinados){
